...
export const catalog: Readonly<Record<string, Named>> = {
  ...
  "agents-with-sessions": named(reportQueries.agentsWithSessions, "Agents with the name, start time, and last activity of their session.", [], "Sessions", "When you want each agent together with its session name and idle time.", true),
